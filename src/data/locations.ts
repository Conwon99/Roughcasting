...
const locationEntries = [
  ...
  },
  {
    ...
    nearby: ["Troon", "Prestwick", "Kilmarnock", "Maybole"],
  },
  {
    slug: "kilmarnock",
    name: "Kilmarnock",
    ...
    nearby: ["Irvine", "Ayr", "Beith", "Galston"],
  },
  {
    slug: "saltcoats",
    name: "Saltcoats",
  ...
  },
  {
    ...
    nearby: ["Ardrossan", "Saltcoats", "West Kilbride"],
  },
  {
    slug: "stevenston",
    name: "Stevenston",
  ...
  },
  {
    ...
    nearby: ["Kilwinning", "Kilmarnock", "Dalry", "Johnstone"],
  },
  {
    slug: "girvan",
    name: "Girvan",
    description: `${brand} provides roughcasting, render and plastering in Girvan and surrounding South Ayrshire.`,
    intro: `${brand} covers Girvan for roughcasting, render and plastering work, from coastal homes to garden walls.`,
    nearby: ["Maybole", "Ayr"],
  },
  {
    slug: "maybole",
    name: "Maybole",
    description: `${brand} provides roughcasting, render and plastering in Maybole and surrounding South Ayrshire.`,
    intro: `${brand} works in Maybole on roughcasting, render and plastering, with free quotes for local homeowners.`,
    nearby: ["Girvan", "Ayr", "Prestwick"],
  },
  {
    slug: "cumnock",
    name: "Cumnock",
    description: `${brand} provides roughcasting, render and plastering in Cumnock and surrounding East Ayrshire.`,
    intro: `${brand} covers Cumnock for roughcasting, smooth render and plastering work, from repairs to full renders.`,
    nearby: ["Galston", "Newmilns", "Kilmarnock"],
  },
  {
    slug: "kilbirnie",
    name: "Kilbirnie",
    description: `${brand} provides roughcasting, render and plastering in Kilbirnie and surrounding North Ayrshire.`,
    intro: `${brand} helps Kilbirnie customers with roughcasting, render repairs and plastering, completed with free quotes.`,
    nearby: ["Dalry", "Beith", "West Kilbride"],
  },
  {
    slug: "dalry",
    name: "Dalry",
    description: `${brand} provides roughcasting, render and plastering in Dalry and surrounding North Ayrshire.`,
    intro: `${brand} covers Dalry for roughcasting and render work, including garden walls, garages and full houses.`,
    nearby: ["Kilbirnie", "Beith", "West Kilbride"],
  },
  {
    slug: "west-kilbride",
    name: "West Kilbride",
    description: `${brand} provides roughcasting, render and plastering in West Kilbride and surrounding North Ayrshire.`,
    intro: `${brand} covers West Kilbride for roughcasting and render work on homes exposed to coastal Ayrshire weather.`,
    nearby: ["Largs", "Dalry", "Kilbirnie"],
  },
  {
    slug: "galston",
    name: "Galston",
    description: `${brand} provides roughcasting, render and plastering in Galston and surrounding East Ayrshire.`,
    intro: `${brand} works in Galston on garden walls, garages and full house roughcasting with tidy workmanship.`,
    nearby: ["Newmilns", "Kilmarnock", "Cumnock"],
  },
  {
    slug: "newmilns",
    name: "Newmilns",
    description: `${brand} provides roughcasting, render and plastering in Newmilns and surrounding East Ayrshire.`,
    intro: `${brand} covers Newmilns for roughcasting, smooth render and plastering work, from garden walls to full houses.`,
    nearby: ["Galston", "Kilmarnock", "Cumnock"],
  },
  {
    slug: "paisley",
    name: "Paisley",
    description: `${brand} provides roughcasting, render and plastering in Paisley and surrounding Renfrewshire.`,
    intro: `${brand} covers Paisley for roughcasting, render and plastering work, from garden walls to full house renders.`,
    nearby: ["Johnstone", "Beith"],
  },
  {
    slug: "johnstone",
    name: "Johnstone",
    description: `${brand} provides roughcasting, render and plastering in Johnstone and surrounding Renfrewshire.`,
    intro: `${brand} helps Johnstone customers with roughcasting, render repairs and plastering, completed with free quotes.`,
    nearby: ["Paisley", "Beith", "Kilbirnie"],
  },
];
