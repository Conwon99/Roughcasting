...
export const services: ServicePage[] = [
  {
    ...
    parentCategorySlug: "roughcasting-irvine-kilwinning",
    description: `Full house roughcasting in ${cities} and ${region}. Complete render systems finished with your choice of chip. Free quotes from ${brand}.`,
    ...
    localContext: `Houses across ${cities} face exposed, coastal Ayrshire weather that puts real strain on render. If you are searching for a roughcaster near ${primaryCity} or ${secondaryCity}, ${brand} covers the full local area and can talk through chip and colour options for your property.`,
    ...
    benefits: [
      ...
      `Free quotes across ${cities} and surrounding Ayrshire.`,
    ],
    process: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. ${brand} roughcasts full houses across ${cities} and surrounding Ayrshire. Contact us with your location for a free quote.`,
      },
    ],
  },
  {
    ...
    navTitle: "Extensions",
    parentCategorySlug: "roughcasting-irvine-kilwinning",
    description: `Extension roughcasting in ${cities} and ${region}, matched to the existing house render. Free quotes from ${brand}.`,
    ...
    localContext: `New builds and extensions across ${cities} and ${region} are common, and getting the finish matched properly makes a real difference to kerb appeal. ${brand} can visit to match chip and colour before quoting.`,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. ${brand} covers extension roughcasting across ${cities} and surrounding Ayrshire.`,
      },
    ],
  },
  {
    ...
    parentCategorySlug: "garden-wall-garage-roughcasting-irvine-kilwinning",
    description: `Garden wall roughcasting in ${cities} and ${region}, finished with coping stones. Free quotes from ${brand}.`,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. ${brand} roughcasts garden walls across ${cities} and surrounding Ayrshire. Contact us for a free quote.`,
      },
    ],
  },
  {
    ...
    navTitle: "Garages",
    parentCategorySlug: "garden-wall-garage-roughcasting-irvine-kilwinning",
    description: `Garage roughcasting in ${cities} and ${region}, base coated and finished to match your house. Free quotes from ${brand}.`,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. ${brand} covers garage roughcasting across ${cities} and surrounding Ayrshire.`,
      },
    ],
  },
  {
    ...
    parentCategorySlug: "smooth-render-irvine-kilwinning",
    description: `Smooth render finishes in ${cities} and ${region}, giving a clean, paintable exterior. Free quotes from ${brand}.`,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. ${brand} applies smooth render across ${cities} and surrounding Ayrshire.`,
      },
    ],
  },
  {
    ...
    navTitle: "Repairs",
    parentCategorySlug: "smooth-render-irvine-kilwinning",
    description: `Render repairs and patch-ups in ${cities} and ${region}. Cracked, blown or damaged render fixed. Free quotes from ${brand}.`,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. ${brand} repairs render across ${cities} and surrounding Ayrshire.`,
      },
    ],
  },
  {
    ...
    navTitle: "Plastering",
    parentCategorySlug: "plastering-irvine-kilwinning",
    description: `Interior plastering in ${cities} and ${region}. Full skims and patch repairs, finished smooth. Free quotes from ${brand}.`,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `Yes. ${brand} plasters properties across ${cities} and surrounding Ayrshire.`,
      },
    ],
  },
  {
    ...
    description: `Request a free quote from ${brand} for roughcasting, render and plastering work across ${cities} and ${region}.`,
    ...
    localContext: `${brand} covers ${cities} and towns across ${region}. If you are nearby, get in touch to confirm coverage for your property.`,
    ...
    benefits: [
      ...
      `Local service across ${cities} and ${region}.`,
    ...
    faq: [
      ...
      },
      {
        ...
        answer: `${brand} covers ${cities} and surrounding towns across ${region}.`,
      },
    ],
  },
];
